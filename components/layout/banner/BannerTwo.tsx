            ...
            <div className="col-xl-6 col-lg-6 col-md-6">
              <div className="hero__content-wrapper">
                <div className="hero__content mb-60">
                  <span className="aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
                  ...
                  <p className="aos-init aos-animate" data-aos="fade-up" data-aos-delay="600">
                ...
                <div
                  className="hero__btn-link aos-init aos-animate"
                  data-aos="fade-up"
                  data-aos-delay="800"
                >
