  ...
  return (
    <section className="hero__area-3 hero__hight-3 d-flex align-items-center p-relative">
      <div className="hero__shape-9">
        <Image priority src={One} alt="Image" />
      </div>
      <div className="hero__shape-10">
        <Image priority src={Two} alt="Image" />
      </div>
      <div className="hero__shape-11">
        <Image priority src={Three} alt="Image" />
      </div>
            ...
            <div className="col-xl-7 col-lg-6">
              <div className="hero__content-wrapper-3">
                <div className="hero__filter">
                  <form action="#">
                    <div
                      className="hero__filter-input aos-init aos-animate"
                      data-aos="fade-up"
                      data-aos-delay="300"
                    >
                      <input
                ...
                <div className="hero__content-3 mb-60">
                  <h2 className="aos-init aos-animate" data-aos="fade-up" data-aos-delay="500">
                    Smarter way to serve digital product marketing
                  </h2>
                  <p className="aos-init aos-animate" data-aos="fade-up" data-aos-delay="700">
            ...
            <div className="col-xl-5 col-lg-6">
              <div className="hero__thumb-wrapper-2 mb-60">
                <div className="hero__thumb-3 w-img">
                  <Image priority src={Four} alt="image not found" />
                </div>
              </div>
            </div>
          </div>
