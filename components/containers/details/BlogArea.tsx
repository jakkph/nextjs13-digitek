  ...
  return (
    <div className="blog__area pt-120 pb-90">
      <div className="container">
        <div
          className="row align-item-center aos-init aos-animate"
          data-aos="fade-up"
          data-aos-delay="300"
        >
              ...
              <div className="blog__content-item">
                ...
                <div className="blog__meta">
                  <div className="blog__meta-thumb">
                    <Image priority src={One} alt="image not found" />
                  </div>
          ...
          <div className="col-xl-6 col-lg-6">
            <div className="blog__thumb-wrapper mb-30">
              <div className="blog__thumb w-img">
                <Image priority src={Two} alt="image not found" />
              </div>
              <div className="blog__thumb w-img">
                <Image priority src={Three} alt="image not found" />
              </div>
            </div>
          </div>
          <div className="col-xl-6 col-lg-6">
            <div className="blog__thumb-wrapper mb-30">
              ...
              <div className="blog__thumb w-img">
                <Image priority src={Five} alt="image not found" />
              </div>
            </div>
          </div>
          <div className="col-xl-6 col-lg-6">
          ...
          <div className="col-xl-6 col-lg-6">
            <div className="blog__thumb-wrapper mb-30">
              ...
              <div className="blog__thumb w-img">
                <Image priority src={Six} alt="image not found" />
              </div>
            </div>
          </div>
        </div>
